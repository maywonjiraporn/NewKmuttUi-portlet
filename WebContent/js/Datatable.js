...
(function(h, D, I, k) {
    ...
    function ja(a, b, c) {
        ...
        c !== k && null !== c && (fb(c),
            ...
            h.extend(b, c), E(b, c, "sWidth", "sWidthOrig"),
    ...
    function kb(a) {
        ...
        for (c = l.length; b < c; b++) f = l[b],
            ...
            i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId),
    ...
    function Fa(a) {
        ...
        if (d || !t && !f && !e && j == aa(a) && j == n.length)
            ...
            for (m = e = 0; m < i.length; m++) k = h(n[m]),
                ...
                k = p.bBounding ? Math.ceil(n[m].getBoundingClientRect().width) : k.outerWidth(), e += k, c[i[m]].sWidth = x(k - g);
            b.style.width = x(e);
            o.remove()
        }
        l && (b.style.width = x(l));
    ...
    function Va(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti ? (c = h.inArray(b, G(e, "0")), -1 !== c ? (b = g(e[c], !0),
            ...
            null === b ? e.splice(c, 1) : (e[c][1] = f[b], e[c]._idx = b)) : (e.push([b, f[0], 0]),
            e[e.length - 1]._idx = 0)) : e.length && e[0][0] == b ? (b = g(e[0]),
            e.length = 1, e[0][1] = f[b], e[0]._idx = b) : (e.length = 0,
            e.push([b, f[0]]), e[0]._idx = 0);
        T(a);
    ...
    function Na(a, b) {
        var c = a.renderer,
            d = m.ext.renderer[b];
        return h.isPlainObject(c) && c[b] ? d[c[b]] ||
            d._ : "string" === typeof c ? d[c] ||
            d._ : d._
    }
    ...
    function Nb(a) {
        return function() {
            var b = [xa(
                this[m.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
            return m.ext.internal[a].apply(
                this, b)
        }
    }
    var m = function(a) {
            ...
            this.api = function(a) {
                return a ? new r(xa(
                    this[v.iApiIndex])) : new r(this)
            };
            this.fnAddData = function(a, b) {
                var c = this.api(!0),
                    d = h.isArray(a) && (h.isArray(a[0]) ||
                        h.isPlainObject(a[0])) ? c.rows.add(a) : c.row.add(a);
                (b === k || b) && c.draw();
            ...
            this.fnUpdate = function(a, b, c, d, e) {
                var h = this.api(!0);
                c === k ||
                    null === c ? h.row(b).data(a) : h.cell(b, c).data(a);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "แสดง   _START_  -  _END_  จากทั้งหมด       _TOTAL_ รายการ", 
            sInfoEmpty: "แสดง  0 - 0  จากทั้งหมด   0 รายการ",
            sInfoFiltered: "(ค้นหาจากทั้งหมด   _MAX_ รายการ)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "จำนวนรายการ :   _MENU_",
